...
namespace System.IO
{
    ...
    public static class PathNetCore
    {
        ...
        private static string GetRelativePath(string relativeTo, string path, StringComparison comparisonType)
        {
            ...
            StringBuilder
                sb = new StringBuilder(80); //StringBuilderCache.Acquire(Math.Max(relativeTo.Length, path.Length));
    ...
    internal static class PathInternalNetCore
    {
        ...
        internal static int GetRootLength(string path)
        {
            ...
            bool extendedSyntax = path.StartsWith(ExtendedDevicePathPrefix, StringComparison.OrdinalIgnoreCase);
            bool extendedUncSyntax = path.StartsWith(UncExtendedPathPrefix, StringComparison.OrdinalIgnoreCase);
            if (extendedSyntax)
            {
